...
def search_videos(query: str, max_results: int = 5) -> List[Dict[str, str]]:
    """
    Search for YouTube videos (mock implementation)
    ...
    try:
        ...
        # In production, replace this with actual YouTube Data API calls
        mock_results = [
            {
                "video_id": "dQw4w9WgXcQ",
                "title": f"{query} - Tutorial 1",
                "description": "This is a tutorial video about " + query + ". It covers the basics and provides step-by-step instructions.",
                "channel_title": "Education Channel",
                "thumbnail_url": "https://img.youtube.com/vi/dQw4w9WgXcQ/hqdefault.jpg"
            },
            {
                "video_id": "jNQXAC9vRw",
                "title": f"{query} - Advanced Guide",
                "description": "Advanced guide for " + query + " with detailed explanations and examples.",
                "channel_title": "Expert Tutorials",
                "thumbnail_url": "https://img.youtube.com/vi/jNQXAC9vRw/hqdefault.jpg"
            },
            {
                "video_id": "9bZkp7q1930",
                "title": f"{query} - Best Practices",
                "description": "Best practices and tips for working with " + query + ". Essential information for beginners and experts alike.",
                "channel_title": "Professional Academy",
                "thumbnail_url": "https://img.youtube.com/vi/9bZkp7q1930/hqdefault.jpg"
            }
        ]
